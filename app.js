...
// app.use(bodyParser.urlencoded({ //设置接受的参数格式是urlencoded
...
app.use('/api/addhome',require('./routes/api/addhome')) //++++++++++++++++++++++
app.use('/api/myarticle',require('./routes/api/myarticle'))
...
console.log("req.urljudge",req.url.includes('/api'));
